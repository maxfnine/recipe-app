...
public class IngredientServiceImplTest {
    ...
    public void findByRecipeIdAndReceipeIdHappyPath() throws Exception {
        ...
        Ingridient ingredient1 = new Ingridient();
        ingredient1.setId(1L);

        Ingridient ingredient2 = new Ingridient();
        ingredient2.setId(1L);

        Ingridient ingredient3 = new Ingridient();
        ingredient3.setId(3L);

        recipe.addIngridient(ingredient1);
        recipe.addIngridient(ingredient2);
        recipe.addIngridient(ingredient3);
    ...
    public void testSaveRecipeCommand() throws Exception {
        ...
        savedRecipe.addIngridient(new Ingridient());
