...
import guru.springframework.recipeapp.domain.Ingridient;
...
@Slf4j
@Service
public class IngredientServiceImpl implements IngridientService {
    ...
    public IngredientCommand findByRecipeIdAndIngredientId(Long recipeId, Long ingredientId) {
        ...
        Optional<IngredientCommand> ingredientCommandOptional = recipe.getIngridients().stream()
    ...
    public IngredientCommand saveIngredientCommand(IngredientCommand command) {
        ...
        if (!recipeOptional.isPresent()) {
            ...
            if (ingredientOptional.isPresent()) {
                ...
                //add new Ingredient
                Ingridient ingredient = ingredientCommandToIngredient.convert(command);
